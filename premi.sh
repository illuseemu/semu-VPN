...
date_list=$(date +"%Y-%m-%d" -d "$data_server")
  ...
  # // Banner
echo -e "${YELLOW}=========================================================${NC}"
echo -e " WELCOME TO SEMU TUNNELING SCRIPT ${YELLOW}(${NC}${green}Stable Edition${NC}${YELLOW})${NC}"
echo -e " HATI-HATI SCRIPT INI TERPASANG BACKDOR ⚠️"
echo -e "${purple}=========================================================${NC}"
echo -e " ›AUTHOR : ${green}TOMKET STORE ${NC}${YELLOW}(${NC}${green}V.5${NC}${YELLOW})${NC}"
echo -e " ›TEAM : SEMU VPN ${YELLOW}(${NC} 2024 ${YELLOW})${NC}"
echo -e "${YELLOW}=========================================================${NC}"
echo ""
sleep 2
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/illuseemu/semu-VPN/main/"
...
clear
izinsc="https://raw.githubusercontent.com/illuseemu/izin/main/ip"
# USERNAME
rm -f /usr/bin/user
...
<code>────────────────────</code>
<b> SEMU VPN STORE SCRIPT  </b>
<code>────────────────────</code>
<i>Automatic Notifications From Github</i>
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"t.me/Tomketstore"}]]}' 
...
wget -q https://raw.githubusercontent.com/illuseemu/semu-VPN/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
echo ""
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
echo -e "\e[96;1m          -[ SEMU TUNNELING PROJECT ]-                 \e[0m"
echo -e "\e[94;1m╚═════════════════════════════════════════════════╝\e[0m"
echo -e ""
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
